...
namespace Zaya
{
    ...
    partial void DeleteUtilisateur(Utilisateur instance);
		...
		public ZayaDBDataContext() : 
				base(global::Zaya.Properties.Settings.Default.ZayaConnectionString2, mappingSource)
		{
			OnCreated();
		}
    ...
    partial void OntxtReponseChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_txtReponse", DbType="VarChar(MAX) NOT NULL", CanBeNull=false)]
